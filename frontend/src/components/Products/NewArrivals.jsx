...
const NewArrivals = () => {
  ...
  return (
    <section className="container mx-auto text-center mb-10 relative">
      ...
      <p className="text-lg text-gray-600 mb-8">Discover the latest style straight off the runway, freshly added to keep your wardrobe on the cutting edge of fahsion.</p>
      {/* scroll button */}
      <div className="absolute right-0 top-[30px] flex space-x-2">
