...
const Hero = () => {
  return (
    <section className='relative'>
      <img src={heroImg} alt='Rabbit' className='w-full h-[400px] md:h-[600] lg:h-[750] object-cover'></img>
      <div className='absolute inset-0 bg-gray-950/20 flex items-center justify-center'>
